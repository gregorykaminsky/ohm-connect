variable "cluster_name" { default = "ohmconnect"}
...
resource "aws_s3_bucket" "ohm-connect" {
    bucket = "ohm-connect-gregory" 
    acl = var.acl_value
